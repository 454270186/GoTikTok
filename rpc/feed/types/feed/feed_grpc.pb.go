...
func (c *feedServiceClient) GetUserFeed(ctx context.Context, in *FeedReq, opts ...grpc.CallOption) (*FeedRes, error) {
	out := new(FeedRes)
...
type FeedServiceServer interface {
	GetUserFeed(context.Context, *FeedReq) (*FeedRes, error)
...
func (UnimplementedFeedServiceServer) GetUserFeed(context.Context, *FeedReq) (*FeedRes, error) {
...
func _FeedService_GetUserFeed_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FeedServiceServer).GetUserFeed(ctx, req.(*FeedReq))
	}
